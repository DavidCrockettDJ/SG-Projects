        ...
        <div class="container">
            <div id='cssmenu'>
                <ul>
                    ...
                    <li class='last'><a href='${pageContext.request.contextPath}'><span>Sightings</span></a></li>
                </ul>
            </div>
            <br/>
            <br/>
            ...
            <div style='text-align: center;'>
                <a href='addSighting'><button class='btn btn-default' style='background-color: black; color: #0f71ba'>Add Sighting!</button></a>
            </div>
        </div>
