            ...
            <div class ="col-md-offset-2 col-md-8">
                <form class="form-vertical" 
                    ...
                    <div class="form-group">
                        ...
                        <label for="userSelect" class="col-md-3 control-label">Select Hero to Remove:</label>
                        <div class="col-md-6">
                            <select name="userSelect" class="form-control" id="removeUser">
                                <c:forEach var="user" items="${users}">                          
                                    <option value="${user.profileID}">${user.userName}</option>
                                </c:forEach>  
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-9">
                            <button type="submit" name="removeUserButton" value="Remove User" class="btn btn-default">Remove</button>
                        </div>
                    </div>
                </form>
            </div>
